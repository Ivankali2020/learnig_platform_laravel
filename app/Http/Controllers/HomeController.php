...
//        return $course;
    ...
    public function UserCart()
    {
        ...
        $wallet_money = Wallet::where('user_id',Auth::id())->pluck('money')[0];
        ...
        if(count($carts) > 0) {
            ...
            $total = array_sum($a);
            return view('cart', compact('carts', 'total','wallet_money')); //take cart in database
        }



        return view('cart', compact('carts','wallet_money')); //take cart in database
