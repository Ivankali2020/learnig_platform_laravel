...
Route::group(['middleware' => ['auth']],function (){
    ...
    Route::put('/user/profilePhoto/{id}',[\App\Http\Controllers\UserController::class,'changeProfilePhoto'])->name('changeProfilePhoto');

    Route::get('userProfile',[\App\Http\Controllers\UserController::class,'userProfile'])->name('profile');
