                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item mx-md-3 mx-0  animate__animated animate__fadeInRightBig position-absolute  " style="top: 3px;right: 50px">
                                <a class="nav-link  pl-4 pl-md-2 " href="{{ route('profile') }}">
                                    <img src="{{ asset('photo/profile.png') }}" width="30" class="border   rounded rounded-circle " alt="">
                                </a>
                            </li>
                        @endguest
                    </ul>
